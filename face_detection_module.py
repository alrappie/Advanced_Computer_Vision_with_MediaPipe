    ...
    def find_faces(self,img,draw=True):
        ...
        if self.results.detections:
            ...
            ## manual draw
                ...
                cv2.putText(img,f'{int(detection.score[0]*100)}%',(bbox[0],bbox[1]-20),cv2.FONT_HERSHEY_COMPLEX,3,(255,0,255),2)
...
def main():
    ...
    while True:
        ...
        fps = 1/(cTime-pTime)
        pTime = cTime
        cv2.putText(img,f'FPS : {int(fps)}',(20,70),cv2.FONT_HERSHEY_COMPLEX,2,(255,0,255),2)
        # result = 
